...
def test_transparency(main=False):
    albumFolderBasename = 'testTransparency'
    albumBasename = 'testTransparency'
    ...
    # Adjust this if the MCF uses a different album format.
    tryToBuildBook(inFile, outFile, latestResultFile, False, 28)


if __name__ == '__main__':
    test_transparency(main=True)
