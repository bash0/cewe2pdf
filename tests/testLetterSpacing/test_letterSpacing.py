# This fixture is isolated so it can use its own configuration and assets.
...
def test_letterSpacing(main=False):
    albumFolderBasename = 'testLetterSpacing'
    albumBasename = 'testLetterSpacing'
