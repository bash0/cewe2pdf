...
from imageareas import _isSavedIndexImage


def test_savedIndexImageRecognitionUsesOutputStem():
    """Saved CEWE resources retain our index suffix after their own prefix."""
    savedImage = 'safecontainer:/mmtd9qge_1_test_indexmultipage.mcf.s.idx.1.png'
...
def defineCommonVariables():
    albumFolderBasename = 'testIndexMultipage'
    albumBasename = "test_indexMultipage"
